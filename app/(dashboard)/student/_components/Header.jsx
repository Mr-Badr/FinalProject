						...
						<li className="dropdown ms-2 d-inline-block position-static">
							...
							<div className="dropdown-menu dropdown-menu-end position-absolute mx-3 my-5">
								...
								<ul className="list-unstyled">
									<li>
										<a className="dropdown-item" href="/student/profile-edit">
											<i className="fe fe-user me-2"></i>
											الملف الشخصي
										</a>
									</li>
									<li>
										<a className="dropdown-item" href="/student/notifications">
											<i className="fe fe-star me-2"></i>
											الإشعارات
										</a>
									</li>
									<li>
										<a className="dropdown-item" href="/student/profile-privacy">
