			...
			<div className="collapse navbar-collapse" id="sidenav">
				<div className="navbar-nav flex-column">
					...
					<ul className="list-unstyled ms-n2 mb-4">
						...
						{/*  Nav item  */}
						<li className={pathname === '/student/my-courses' ? 'nav-item tajawal-bold active' : 'nav-item'}>
							<Link href="/student/my-courses" className="nav-link">
								<i className="fe fe-book-open nav-icon"></i>
								<span className={pathname === '/student/my-courses' ? 'tajawal-bold' : ''}>
									دوراتي
								</span>
							</Link>
						</li>
					...
					<ul className="list-unstyled ms-n2 mb-0">
						...
						{/*  Nav item  */}
						<li className={pathname === '/student/profile-privacy' ? 'nav-item tajawal-bold active' : 'nav-item'}>
							<Link href="/student/profile-privacy" className="nav-link">
								<i className="fe fe-lock nav-icon"></i>
								<span className={pathname === '/student/profile-privacy' ? 'tajawal-bold' : ''}>
									إعدادات الخصوصية
								</span>
							</Link>
						</li>
