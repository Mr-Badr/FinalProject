						...
						<div className="mb-2 mb-lg-0">
							...
							<nav aria-label="breadcrumb">
								<ol className="breadcrumb">
									...
									<li className="breadcrumb-item active" aria-current="page">دروس</li>
								</ol>
							</nav>
						</div>
						<div className="nav btn-group" role="tablist">
							<div className='me-2'>
								<Link href="/admin/lessons-add" className="btn btn-primary" data-bs-target="#newCatgory" alt="">إضافة درس جديد</Link>
							</div>
				...
				<div className="col-lg-12 col-md-12 col-12">
					...
					<div className="tab-content">
						...
						<div className="tab-pane fade" id="tabPaneGrid" role="tabpanel" aria-labelledby="tabPaneGrid">
							<div className="mb-4">
								<input type="search" className="form-control" placeholder="بحث الدروس" />
							</div>
							<div className="row">
