    ...
    <section className="container-fluid p-4">
						...
						<div className="col-lg-12 col-md-12 col-12">
							<div className="border-bottom pb-3 mb-3 d-md-flex align-items-center justify-content-between">
								<div className="mb-3 mb-md-0">
									<h1 className="mb-1 tajawal-bold">إضافة منشور جديد</h1>
									{/*  Breadcrumb  */}
									<nav aria-label="breadcrumb">
										<ol className="breadcrumb">
											...
											<li className="breadcrumb-item active" aria-current="page">إضافة منشور جديد</li>
										</ol>
									</nav>
								</div>
								<div>
									<a href="#" className="btn btn-outline-secondary">العودة إلى كافة المشاركات</a>
								</div>
							</div>
						</div>
					</div>
					<div className="row">
						<div className="col-xl-9 col-lg-8 col-md-12 col-12">
							...
							<div className="card border-0 mb-4">
								...
								<div className="card-header">
									<h4 className="mb-0 tajawal-bold">إنشاء منشور</h4>
								</div>
								<form className="needs-validation">
									...
									<div className="card-body">
										...
										<label className="btn btn-outline-secondary" htmlFor="option3">اقتباس</label>
										...
										<div className="mt-4">
											...
											<div className="row">
												...
												<div className="mb-3 col-md-9">
													...
													<input type="text" id="postTitle" className="form-control text-dark" placeholder="عنوان المنشور" required="" />
													<small>اجعل عناوين مشاركاتك أقل من 60 حرفًا. اكتب عنوانًا يصف محتوى الموضوع. ضع سياقًا لجمهورك.</small>
												...
												{/*  Excerpt  */}
												<div className="mb-3 col-md-9">
													<label htmlFor="Excerpt" className="form-label">خبير</label>
													<textarea rows="3" id="Excerpt" className="form-control text-dark" placeholder="خبير"></textarea>
													<small>مقتطف قصير من الكتابة.</small>
												</div>
												{/*  Category  */}
												<div className="mb-3 col-md-9">
													<label className="form-label" htmlFor="category">الصنف</label>
													<select className="form-select" id="category" required="">
														<option value="">الدرس</option>
														<option value="Post Category">صنف المنشور</option>
                      ...
                      {/* Editor Shuold be here */}
										...
										<button type="submit" className="btn btn-outline-secondary">حفظ في المسودة</button>
									</div>
								</form>
							</div>
						</div>
						<div className="col-xl-3 col-lg-4 col-md-12 col-12">
							...
							<div className="card mt-4 mt-lg-0 mb-4">
								...
								<div className="card-header d-lg-flex">
									<h4 className="mb-0 tajawal-bold">معلومات المشاركة</h4>
								</div>
								{/*  List Group  */}
								<ul className="list-group list-group-flush">
									<li className="list-group-item">
										<span className="text-body">مشاركة ID</span>
										<h5>8693637308</h5>
									</li>
									<li className="list-group-item">
...
export default AdminCmsPostNew