                  ...
                  <div className="simplebar-content" style={{ padding: "0px" }}>
                    ...
                    <ul className="navbar-nav flex-column" id="sideNavbar">
                      <li className="nav-item">
                        ...
                        <div
                          id="navDashboard"
                          className={pathname === '/admin' || pathname === '/admin/dashboard-analytics' ? 'collapse  show ' : 'collapse'}
                        ...
                        >
                          <ul className="nav flex-column">
                            ...
                            {/*  Nav item  */}
                            <li className="nav-item">
                              <Link href="/admin/dashboard-analytics" className={pathname === '/admin/dashboard-analytics' ? 'nav-link active' : 'nav-link'}>
                                التحليلات
                              </Link>
                            </li>
                          </ul>
                      ...
                      <li className="nav-item">
                        ...
                        <div
                          id="navProfile"
                          className={pathname === '/admin/teachers' | pathname === "/admin/teachers-add" ? 'collapse  show ' : 'collapse'}
                          data-bs-parent="#sideNavbar"
                        >
                          <ul className="nav flex-column">
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                              <Link href="/admin/teachers-add" className={pathname === '/admin/teachers-add' ? 'nav-link active' : 'nav-link'}>
                                إضافة أستاذ
                              </Link>
                            </li>
                          </ul>
