						...
						<div className="col-xl-9 col-lg-8 col-md-12 col-12">
							...
							<div className="card border-0 mb-4">
								...
								<div className="card-header">
									<h4 className="mb-0 tajawal-bold">إنشاء دورة </h4>
								</div>
										...
										<div className="mt-4">
											...
											<div className="row">
												...
												<div className="mb-3 col-md-9">
													...
													<input type="text" id="postTitle" className="form-control text-dark" placeholder="عنوان الدورة" required="" />
						...
						<div className="col-xl-3 col-lg-4 col-md-12 col-12">
							...
							<div className="card mt-4 mt-lg-0 mb-4">
								...
								<div className="card-header d-lg-flex">
									<h4 className="mb-0 tajawal-bold">معلومات الدورة</h4>
								</div>
								{/*  List Group  */}
								<ul className="list-group list-group-flush">
									<li className="list-group-item">
										<span className="text-body">الدورة ID</span>
										<h5>8693637308</h5>
									</li>
									<li className="list-group-item">
