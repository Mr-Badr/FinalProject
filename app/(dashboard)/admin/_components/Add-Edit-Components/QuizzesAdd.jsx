					...
					<div className="row">
						...
						<div className="col-lg-12 col-md-12 col-12">
							<div className="border-bottom pb-3 mb-3 d-md-flex align-items-center justify-content-between">
								...
								<div>
									<Link href="/admin/quizzes" className="btn btn-outline-secondary">العودة إلى كافة المسابقات</Link>
								</div>
							</div>
						</div>
					</div>
						...
						<div className="col-xl-9 col-lg-8 col-md-12 col-12">
							...
							<div className="card border-0 mb-4">
								...
								<div className="card-header">
									<h4 className="mb-0 tajawal-bold">إنشاء مسابقة </h4>
								</div>
										...
										<div className="mt-4">
											...
											<div className="row">
												...
												<div className="mb-3 col-md-9">
													...
													<input type="text" id="postTitle" className="form-control text-dark" placeholder="عنوان المسابقة" required="" />
													<small>اجعل عناوين مسابقاتك أقل من 60 حرفًا. اكتب عنوانًا يصف محتوى الموضوع. ضع سياقًا لجمهورك.</small>
						...
						<div className="col-xl-3 col-lg-4 col-md-12 col-12">
							...
							<div className="card mt-4 mt-lg-0 mb-4">
								...
								<div className="card-header d-lg-flex">
									<h4 className="mb-0 tajawal-bold">معلومات المسابقة</h4>
								</div>
								{/*  List Group  */}
								<ul className="list-group list-group-flush">
									<li className="list-group-item">
										<span className="text-body">المسابقة ID</span>
										<h5>8693637308</h5>
									</li>
									<li className="list-group-item">
