						...
						<div className="col-lg-9 col-md-8 col-12">
							...
							<div className="card">
								...
								<div className="card-header">
									<h3 className="mb-2">حسابات متصلة</h3>
									<p className="mb-0">
								...
								<div className="card-body tajawal-bold">
									<div className="mb-5 d-md-flex">
										{/*  facebook  */}
										<div>
											<span className="color-facebook me-3 align-text-top">
										...
										<span>
											<h4 className="mb-0 tajawal-bold">Facebook</h4>
											<p>قم بتمكين تسجيل الدخول بنقرة واحدة واحصل على توصيات أكثر تخصيصًا للدورة التدريبية.</p>
											<a href="#" className="btn btn-dark btn-sm">إزالة حساب الفيسبوك الخاص بي</a>
										</span>
									</div>
									{/*  Google  */}
									<div className="mb-5 d-md-flex border-top pt-5">
										<div>
											<span className="color-google me-3 align-text-top">
										...
										<span>
											<h4 className="mb-0 tajawal-bold">Google</h4>
											<p>قم بتمكين تسجيل الدخول بنقرة واحدة واحصل على توصيات أكثر تخصيصًا للدورة التدريبية.</p>
											<a href="#" className="btn btn-outline-secondary btn-sm">ربط حسابي في جوجل</a>
										</span>
									</div>
									...
									<div className="mb-5 d-md-flex border-top pt-5">
										<div>
											<span className="color-github me-3 align-text-top">
										...
										<div>
											<h4 className="mb-0 tajawal-bold">Github</h4>
											<p>قم بتمكين تسجيل الدخول بنقرة واحدة واحصل على توصيات أكثر تخصيصًا للدورة التدريبية.</p>
											<a href="#" className="btn btn-outline-secondary btn-sm">ربط حساب Github الخاص بي</a>
										</div>
									</div>
									...
									<div className="mb-5 d-md-flex border-top pt-5">
										<div>
											<span className="color-twitter me-3 align-text-top">
										...
										<span>
											<h4 className="mb-0 tajawal-bold">Twitter</h4>
											<p>قم بتمكين تسجيل الدخول بنقرة واحدة واحصل على توصيات أكثر تخصيصًا للدورة التدريبية.</p>
											<a href="#" className="btn btn-outline-secondary btn-sm">ربط حساب Twitter الخاص بي</a>
										</span>
									</div>
								</div>
							</div>
