...
const AddLessonPopup = ({ show, handleClose }) => {
      ...
      <div className="modal-dialog" style={{ maxWidth: '70%', marginTop: "5%" }}>
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">إضافة درس</h5>
          ...
          <div className="modal-body">
            <form onSubmit={handleSubmit}>
              <div className="row">
                ...
                <div className="mb-3 col-lg-4">
                  <label className="form-label">لغة الدرس</label>
              ...
              <div className="modal-footer">
                ...
                <button type="submit" className="btn btn-primary">إضافة درس</button>
              </div>
            </form>
          </div>
        </div>
