											...
											<div className="card-body">
												<form className="row gx-3">
													<div className="col-lg-9 col-md-7 col-12 mb-lg-0 mb-2">
														<input type="search" className="form-control" placeholder="البحث بواسطة إسم الطالب" />
													</div>
													<div className="col-lg-3 col-md-5 col-12">
														<select className="form-select">
															<option value="">اختيار حسب المادة</option>
															<option value="Newest">رياضيات</option>
															<option value="High Rated">علوم </option>
															<option value="Law Rated"> فيزياء</option>
														</select></div>
												</form>
											</div>
								...
								<div style={{
									...
									<div className="modal-content">
										<div className="modal-header">
											<div className="modal-title tajawal-bold">تعديل الطلاب</div>
