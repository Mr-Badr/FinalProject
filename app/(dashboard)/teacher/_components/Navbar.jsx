			...
			<div className="collapse navbar-collapse" id="sidenav">
				<div className="navbar-nav flex-column">
					...
					<ul className="list-unstyled ms-n2 mb-4">
						...
						{/*  Nav item  */}
						<li className={pathname === '/teacher/lessons' ? 'nav-item tajawal-bold active' : 'nav-item'}>
							<Link href="/teacher/lessons" className="nav-link">
								<i className="fe fe-book nav-icon"></i>
								<span className={pathname === '/teacher/lessons' ? 'tajawal-bold' : ''}>
									الدروس
								</span>
							</Link>
						</li>
					...
					<ul className="list-unstyled ms-n2 mb-0">
						...
						{/*  Nav item  */}
						<li className={pathname === '/teacher/profile-privacy' ? 'nav-item tajawal-bold active' : 'nav-item'}>
							<Link href="/teacher/profile-privacy" className="nav-link">
								<i className="fe fe-lock nav-icon"></i>
								<span className={pathname === '/teacher/profile-privacy' ? 'tajawal-bold' : ''}>
									إعدادات الخصوصية
								</span>
							</Link>
						</li>
