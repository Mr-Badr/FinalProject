  ...
  return (
    <section className="py-lg-8 py-6 bg-white">
				<div className="container mb-lg-8">
					...
					<div className="col-xl-6 col-lg-6 col-md-12 col-12">
							<div className="row row-cols-2">
								<div className="col card-hover rounded" dir='rtl'>
									<div className="m-2 mb-xl-6">
										<div className="mb-4">
								...
								<div className="col card-hover rounded" dir='rtl'>
									<div className="mb-lg-6 m-2">
										...
										<div>
											<h4>شبكة تجمع أكثر من 1000 متعلم</h4>
								...
								<div className="col card-hover rounded" dir='rtl'>
									<div className="m-2 mb-md-0">
										...
										<div>
											<h4>جميع المواد لكل المستويات </h4>
                ...
                <div className="position-relative">
								<Image src="/assets/images/object.png" alt="img" width={500} height={300}/>
