...
function Section4() {
  return (
    <section className="bg-light py-8 bg-white">
          ...
          <div className="offset-xl-1 col-xl-10 col-md-12 col-12">
            <div className="row text-center">
              <div className="col-md-12 px-lg-8 mb-8 mt-6">
                ...
                <span className="text-uppercase text-primary tajawal-bold ls-md">Browse Category</span>


                <h2 className="h1 tajawal-bold mt-3">Discover jobs across popular roles</h2>
            ...
            <div className="row gy-4">
              <div className="col-lg-3 col-md-4 col-12">
                ...
                <div className="card border-top border-4 card-hover-with-icon">
                  ...
                  <div className="card-body">
                    ...
                    <div className="icon-shape icon-lg rounded-circle bg-light mb-3 card-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-activity" viewBox="0 0 16 16">
                        <path fillRule="evenodd" d="M6 2a.5.5 0 0 1 .47.33L10 12.036l1.53-4.208A.5.5 0 0 1 12 7.5h3.5a.5.5 0 0 1 0 1h-3.15l-1.88 5.17a.5.5 0 0 1-.94 0L6 3.964 4.47 8.171A.5.5 0 0 1 4 8.5H.5a.5.5 0 0 1 0-1h3.15l1.88-5.17A.5.5 0 0 1 6 2z"></path>
                      </svg>
                    </div>
                    <div className="d-flex align-items-center justify-content-between">
                      <div>
                        ...
                        <h4 className="mb-0 tajawal-bold">Analtyics</h4>


                        <p className="mb-0">2k Jobs</p>
                      </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      <div>
                        ...
                        <h4 className="mb-0 tajawal-bold">UI / UX Design</h4>


                        <p className="mb-0">1k Jobs</p>
                      </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      <div>
                        ...
                        <h4 className="mb-0 tajawal-bold">Developer</h4>

                        <p className="mb-0">800 Jobs</p>
                      </div>
                      <a href="#" className="text-inherit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-right" viewBox="0 0 16 16">
                          <path fillRule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"></path>
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      <div>
                        ...
                        <h4 className="mb-0 tajawal-bold">Product Manager</h4>

                        <p className="mb-0">1.2K Jobs</p>
                      </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      <div>
                        ...
                        <h4 className="mb-0 tajawal-bold">SEO</h4>

                        <p className="mb-0">1200 Jobs</p>
                      </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      <div>
                        ...
                        <h4 className="mb-0 tajawal-bold">Data Analytics</h4>
                        <p className="mb-0">200 Jobs</p>
                      </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      <div>
                        ...
                        <h4 className="mb-0 tajawal-bold">Mobile Developer</h4>

                        <p className="mb-0">120 Jobs</p>
                      </div>
                      <a href="#" className="text-inherit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-right" viewBox="0 0 16 16">
                          <path fillRule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"></path>
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      <div>
                        ...
                        <h4 className="mb-0 tajawal-bold">Finance</h4>


                        <p className="mb-0">5k Jobs</p>
                      </div>
                      <div>
              ...
              <div className="col-12 mt-8 text-center">
                <a href="#" className="btn btn-outline-primary">View All Category</a>
              </div>
            </div>
          </div>
        </div>
