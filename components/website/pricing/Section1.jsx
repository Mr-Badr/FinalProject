          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-12 col-12">
              <div className="mb-3 border shadow-none border-top-0 card">
                <div className="border-6 rounded-3 border-dark-warning" style={{ borderTop: "6px solid #e2e8f0" }}>
                  <div className="p-5">
                    <div className="mb-5">
                      ...
                      <a className="btn btn-outline-dark-warning" href="/pricing/details">اشترك الآن</a>
                    </div>
                    <hr className="m-0" />
                    <div className="mt-5">
                      ...
                      <div className="list-unstyled">
                        <div className="mb-1 list-item">
                          <span className="text-success me-2"><i className="bi bi-check-circle"></i></span>
            ...
            <div className="col-lg-4 col-md-12 col-12">
              <div className="mb-3 border shadow-none border-top-0 card">
                <div className="border-6 rounded-3 border-dark-primary" style={{ borderTop: "6px solid #e2e8f0" }}>
                  <div className="p-5">
                    <div className="mb-5">
            ...
            <div className="col-lg-4 col-md-12 col-12">
              <div className="mb-3 border shadow-none border-top-0 card">
                <div className="border-6 rounded-3 border-dark-info" style={{ borderTop: "6px solid #e2e8f0" }}>
                  <div className="p-5">
                    <div className="mb-5">
                      ...
                      <a className="btn btn-outline-dark-info" href="/pricing/details">اشترك الآن</a>
                    </div>
                    <hr className="m-0" />
                    <div className="mt-5">
                      <h4 className="fw-bold mb-4">الفوائد:</h4>
