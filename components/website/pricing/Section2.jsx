  ...
  <div className="container">
    ...
    <div className="row">
      <div className="col-lg-6 col-md-12 col-12">
        ...
        <div className="border-6 rounded-3 border-dark-success" style={{ borderTop: "6px solid #e2e8f0" }}>
            <div className="p-5">
              <div className="mb-5">
              ...
              لبدء مساعدة طفلك في التعلم، سيحصلون على الوصول إلى الدورات الأساسية فقط.
                ...
                <a className="btn btn-outline-dark-primary" href="/pricing/details">ابدأ مجاناً</a>
              </div>
              <hr className="m-0" />
              <div className="mt-5">
      ...
      <div className="col-lg-6 col-md-12 col-12">
        <div className="mb-3 border shadow-none border-top-0 card">
        <div className="border-6 rounded-3 border-dark-danger" style={{ borderTop: "6px solid #e2e8f0" }}>
            <div className="p-5">
              <div className="mb-5">
                ...
                <a className="btn btn-outline-dark-info" href="/pricing/details">ابدأ اليوم</a>
              </div>
              <hr className="m-0" />
              <div className="mt-5">
